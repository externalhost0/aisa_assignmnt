...
import {
  AppShell, Group, Select, Tabs, Title, Text,
  Container, Loader, Center, Badge,
  useMantineTheme,
} from '@mantine/core'
      ...
      <AppShell.Header>
        <Group h="100%" px="md" justify="space-between">
          <Group gap="xs">
            ...
            <Title order={4} c={theme.primaryColor}>Campus Safety</Title>
          </Group>
            ...
            <Tabs value={activeTab} onChange={v => setActiveTab(v ?? 'board')}>
              <Tabs.List mb="lg">
                ...
                <Tabs.Tab value="board">
                  Incident Board
                  {openCount > 0 && (
                    <Badge color="red" size="xs" ml="xs" variant="filled">{openCount}</Badge>
                  )}
                </Tabs.Tab>
